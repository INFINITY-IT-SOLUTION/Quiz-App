...
import com.QuizApp.userservice.service.ProductService;
...
import com.QuizApp.userservice.jwt.JwtUtils;
import com.QuizApp.userservice.payload.JWTResponse;
...
public class ProductControllerTest {
    ...
    void test_WhenaddProduct_isSuccess() throws Exception {
        ...
        Optional<User> product = productRepository.findById(Long.valueOf(productId));
    ...
    void test_When_getProductById_isSuccess() throws Exception {
        ...
        User product = productRepository.findById(1l).get();
    ...
    private String getMockProductResponse(User product) throws IOException {
